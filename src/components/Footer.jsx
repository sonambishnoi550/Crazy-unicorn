...
const Footer = () => {
  return (
    <div data-aos="fade-up" className='xl:pt-[287px] md:pt-20 pt-10 relative max-w-[1920px] mx-auto'>
      <div className='absolute bottom-0 -z-10 w-full 2xl:hidden block'>
      ...
      <div className="container">
        ...
        <div className='flex gap-5 justify-center lg:pt-[60px] md:pt-12 pt-6'>
        ...
        <p className='text-xl font-normal text-center md:py-16 py-7 '>Copyright@CrazyUnicorn.com</p>
      </div>
    </div>
  )
}
