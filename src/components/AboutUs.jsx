            ...
            <div className="flex flex-col justify-center">
              <div className="flex relative items-center">
                <div className="relative">
                  <img className='max-w-[118px] absolute left-[72%] -top-[66%] max-sm:left-[58%] max-sm:-top-[83%]' src="./assets/images/png/heading-unicorn.png" alt="unicorn" />
                  <CustomHeading
                    text={'About Us'}
              ...
              <CustomDescription classStyle={'!pb-[53px]'} text={'In in ut scelerisque quam purus, quam. Porttitor aenean elit blandit gravida potenti sed. Mauris.'} />
              <div className="bg-white md:max-w-[238px] max-w-[180px] border border-black flex justify-center rounded-xl relative">
                <button className="text-gradient  md:text-custom-3xl text-2xl font-bold lg:py-5 py-3 group">
                  MINT NOW
                  <img src="../assets/images/png/button-bg.png" alt="button-bg" className="absolute -z-10 top-[16%] left-[5%] group-hover:top-0 group-hover:left-0 transition-all duration-700 ease-in" />
                </button>
              </div>
            </div>
          </div>
