    ...
    <div data-aos="flip-left" id='team' className='xl:pb-[147px] pb-10 xl:pt-[660px] lg:pt-[290px] pt-20'>
      <div className="container ">
        ...
        <div className="flex max-xl:flex-wrap gap-6 justify-center xl:pt-[130px] pt-[60px]">
          <div className="border-2 backdrop-blur-[164] border-pink cursor-pointer rounded-[25px] mt-10 bg-offwhite/55 lg:px-[55px] px-6 pb-5 hover:scale-y-110 hover:origin-bottom transition-all duration-500">
